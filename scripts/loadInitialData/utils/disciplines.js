module.exports = (knex) => knex('disciplines').insert([
    ...
    { name: 'Atividades Complementares - BCT' },
    { name: 'Atividades Complementares - Eng Computação' },
    ...
    { name: 'Biomateriais' },
    { name: 'Biomecânica' },
    { name: 'Biomecânica Aplicada à Reabilitação e ao Esporte' },
    { name: 'Bioquímica I' },
    { name: 'Bioquímica II' },
    ...
    { name: 'Cidadania, Ciência e Polêmica' },
    { name: 'Ciência e Engenharia de Biomateriais' },
    ...
    { name: 'Desenvolvimento de Aplicações Robóticas' },
    ...
    { name: 'Econometria' },
    { name: 'Economia Monetária e Bancos' },
    { name: 'ECOS - EB' },
    { name: 'ECOS - EM' },
    ...
    { name: 'Introdução à Economia Global' },
    ...
    { name: 'Introdução à Lógica Fuzzy' },
    ...
    { name: 'Laboratório de sistemas computacionais: Redes de Computadores' },
    { name: 'Laboratório de Sistemas de Comunicação' },
    { name: 'Laboratório de usabilidade na web' },
    { name: 'Legislação Ambiental e Políticas Públicas' },
    ...
    { name: 'Mecânica geral' },
    { name: 'Metalurgia de Ligas Aeronáuticas' },
    { name: 'Metalurgia extrativa' },
    { name: 'Metalurgia física' },
    { name: 'Metalurgia mecânica' },
    { name: 'Metodologia de Pesquisa e Comunicação Científica' },
    ...
    { name: 'Política Científica e Tecnológica' },
    { name: 'Prática em Projetos Extensionistas I' },
    { name: 'Prática em Projetos Extensionistas II' },
    ...
    { name: 'Processamento de Termofixos e Elastômeros' },
    ...
    { name: 'Recuperação de Informação Multimídia' },
    ...
    { name: 'Tópicos em Fundamentos da Computação I' },
    { name: 'Tópicos em Fundamentos da Computação II' },
    { name: 'Tópicos em Fundamentos da Computação III' },
    { name: 'Tópicos em Fundamentos da Computação IV' },
    { name: 'Tópicos em Fundamentos da Computação V' },
