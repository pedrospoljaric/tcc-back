...
module.exports = async (knex) => {
    ...
    return knex('discipline_group_disciplines').insert([
        ...
        { discipline_group_id: groupId, discipline_id: getDisciplineIdByName('Aspectos de Implementação de Bancos de Dados') },
        ...
        { discipline_group_id: groupId, discipline_id: getDisciplineIdByName('Laboratório de Sistemas Computacionais: Sistemas de Comunicação Digital') },
        ...
        { discipline_group_id: groupId, discipline_id: getDisciplineIdByName('Laboratório de Usabilidade Web') },
        ...
        { discipline_group_id: groupId, discipline_id: getDisciplineIdByName('Tópicos em Fundamentos da Computaçãoe V') },
